...
public class Main
{
  ...
  /*-----------------------------------------------------------*/
    ...
    public static void main(String argv[])
    {
        ...
        // Give source code to Lexical Analysis and then Syntax Analysis
        try
        {
        ...
        /*
         * Do Semantic Analysis on the AST produced by Syntax Analysis in
         * previous step. Further ensure correctness of the provided source
         * code and build symbol table for it.
         */
        Semantics sem = null;
        try
        {
            // Code inserted to do semantic analysis using the Reflective Visitor Pattern.
            sem = new Semantics(traceSemantics, compilerTraceFileName);
            sem.doTraversal(programAST);
        } catch (Exception e)
        {
        ...
        /*
         * Generate code for stack machine using the AST that passed semantic
         * check and the symbol table created during semantic analysis.
         */
        try
        {
            CodeGen codeGen = new CodeGen();
            codeGen.setGlobalSymTable(sem.getGlobalSymTable());
            codeGen.doTraversal(programAST);
        } catch (Exception e)
        {
